...
module.exports = {
    ...
    async run (bot, message, args) {
        ...
        .addField('`b!hi`', 'Menciona a un usuario para que Blu lo salude por tí | [Formato: b!hi @usuario]')
        .addField('`b!pat`', 'Úsalo para que le dé un headpat a un usuario que menciones | [Formato: b!pat @usuario]')
